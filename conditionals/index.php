...
echo "<p>Checks to see what day the variable is set to, if so will output 'Bring and umbrella because it is RAINING' or else 'You do not need an umbrella because it is NOT raining, in fact, it is VARIABLE! </p>";
$day = 'Tuesday';
