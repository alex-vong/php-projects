  ...
  <div class="inner-column">
    <header>
      <h1>The <span>__________ </span> (superlative) Madlibs&nbsp;Ever!</h1>
              ...
              ?> <p>Then it happened. I could hear a <span class='madlib2'> <?php echo $verbTwo ?></span> up the
      stairs. My <span class='madlib2'> <?php echo $bodyPartTwo ?></span> started to chatter and my knees began <span
            class='madlib2'> <?php echo $verbThree ?></span>. The <span class='madlib2'> <?php echo $nounTwo ?></span>
      was thrust open and there was a huge <span class='madlib2'> <?php echo $nounFour ?></span> with hair all over his
      <span class='madlib2'> <?php echo $bodyPartThree ?></span>. </p>
